import { and, eq, getTableColumns, ilike, ne, or, SQL } from "drizzle-orm";
import { type NewJabatan, type Jabatan, jabatan, jabatanColumns } from "../jabatan/schema";
import { alias } from "drizzle-orm/pg-core";
import db from "../../../libs/db";
import { ValidationError } from "../../../libs/errors";

export const getJabatan = async (params: any, tx = db) => {
    ...
    if (params.search) {
        search.push(ilike(jabatan.jabatan, `%${params.search}%`));
    }
